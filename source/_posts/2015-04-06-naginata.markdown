...
[naginata/tree/master/integration-test](https://github.com/niku4i/naginata/tree/master/integration-test)にVagrantファイルとサンプルの設定ファイルがあり動作を試せます。vagrant upすると仮想マシンにnagiosをインストールした状態で上がってきます。
...
http://localhost:8880 , http://localhost:8881 で仮想マシン側のnagios画面を確認できます。
